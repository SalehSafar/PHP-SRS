            ...
            If Form1.worksheet.Cells(x, 1).Value = UsernameTextBox.Text Then
                If Form1.worksheet.Cells(x, 2).Value = PasswordTextBox.Text Then
                    ...
                    If Form1.worksheet.Cells(x, 3).Value = "admin" Then
                        ...
                        For y = 1 To ilLastRow
                            managerdisplay += Form1.worksheet.Cells(y, 1).value & vbTab & Form1.worksheet.Cells(y, 2).value & vbTab & Form1.worksheet.Cells(y, 3).value & vbTab & Form1.worksheet.Cells(y, 5).value & vbNewLine
                            Form4.csvsave += Form1.worksheet.Cells(y, 1).value & "," & Form1.worksheet.Cells(y, 2).value & "," & Form1.worksheet.Cells(y, 3).value & "," & Form1.worksheet.Cells(y, 5).value & vbNewLine
